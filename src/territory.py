# Module to store information about territories, areas and the world map.
...
LOG = logging.getLogger("risk-board")

# Classes:

## Class to model a territory.
...
## Class to model an area from the map.
class Area(object):
...
## Class to represent the entire world map.
class World(object):
    ords = list(map(ord, r'\/|-+'))
    def __init__(self):
        self.territories = {}
